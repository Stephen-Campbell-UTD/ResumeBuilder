  ...
  return (
    <div className="MainContainer">
      <div className="HeaderContainer">
        <h1 className="NamePlate">Stephen Campbell</h1>
        <div className="ContactContainer">
          ...
          {/* <!-- MAIL --> */}
          <a href="mailto:kingiskey@gmail.com">
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
      ...
      <section>
        ...
        <div className="RowContainer">
          <p className="Desc DescBold MaxHalf">
        ...
        <div className="RowContainer">
          ...
          <p className="Desc DescBold">GPA: 3.99/4.0</p>
        </div>
        <p className="Desc DescItalic">Academic Excellence Scholar</p>
      </section>
      <section>
        <h2 className="SectionHeader">Professional Experience</h2>
        <div className="RowContainer">
          <p className="Desc DescBold MaxHalf">Outdoor Trip Leader</p>
          <p className="Desc MaxHalf" style={{ textAlign: "right" }}>
            May 2020 - September 2019
          </p>
        </div>
        <div className="RowContainer">
          <p className="Desc">University Recreation</p>
          <p className="Desc">Richardson, TX</p>
        </div>
        <ul className="Bullets Takeaways">
          <li>
            Led 12+ students on off-campus excursions to foster an appreciation
            of the outdoors
          </li>
          <li>
            Adapted to changing needs by taking on new responsibilities ensuring
            positive participant experience
          </li>
          <li>
            Educated participants in outdoor ethics to encourage habits of
            environmental sustainability
          </li>
        </ul>
        {/* <!-- DUPLICATE START --> */}
        <div className="RowContainer">
          <p className="Desc DescBold">Outdoor Trip Leader</p>
          <p className="Desc">May 2020 - September 2019</p>
        </div>
        <div className="RowContainer">
          <p className="Desc">University Recreation</p>
          <p className="Desc">Richardson, TX</p>
      ...
      <section>
        ...
        <div className="RowContainer">
          <p className="Desc DescBold">Robot Arm Design Project</p>
          <p className="Desc">January 2019 - May 2019</p>
        </div>
        <p className="Desc">
          <span className="DescBold">Technologies Used:</span> Javascript,
          Parcel
        </p>
        <ul className="Bullets Takeaways">
          <li>
